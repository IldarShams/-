...
def presentation_page():
    ...
    ---
    ## Введение
    - Задача: разработать модель 
    машинного обучения для предсказания сбоев
    ...
    предсказать отказ оборудования (Target = 1) 
    или его отсутствие (Target = 0).
    ---
    ## Этапы работы
    1. Загрузка данных.
    ...
    ---
    ### 2. Предобработка данных.
    Для обучения необходимо предобработать данные, 
    убрав лишние столбцы, которые не будут учавствовать в обучении
    ...
    with st.sidebar:
        ...
        height = st.number_input("Высота слайдов", value=1000)
